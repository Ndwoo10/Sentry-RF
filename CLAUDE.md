...
**Current version:** v1.5.1 (AAD persistence gate + fast-detect + LED re-enabled, WARNING in 5.1s, CRITICAL in 7.4s, CLEAR return in 10s, zero false alarms, validated April 6 2026)
